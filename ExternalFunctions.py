...
def MassAndStiffness_1D(iElem, Order, Coord, Element):
    ...
    x1 = Coord[Element[0, iElem].astype(int)] #Changed Element[0, iElem-1] to Element[0, iElem] since we look at the current element & in the notebook `iElem` starts at 0...
    x2 = Coord[Element[1, iElem].astype(int)] #Changed Element[0, iElem-1] to Element[0, iElem] since we look at the current element & in the notebook `iElem` starts at 0...
    Le = (x2-x1)
